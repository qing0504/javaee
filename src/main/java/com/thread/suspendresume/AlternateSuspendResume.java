package com.thread.suspendresume;

/**
 * 实现线程挂起和恢复的策略——设置标志位。通过该方法实现线程的挂起和恢复有一个很好的地方，
 * 就是可以在线程的指定位置实现线程的挂起和恢复，而不用担心其不确定性。 
 * 
 * 终止线程的替代方法：同样是使用标志位，通过控制标志位来终止线程。
 * 
 * <p><b>AlternateSuspendResume Description:</b></p>
 * @author wanchongyang
 * <b>DATE</b> 2016年8月8日 上午10:36:32
 */
