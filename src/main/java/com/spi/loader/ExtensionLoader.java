...
public class ExtensionLoader<T> {
     ...
     */
    private static final String TEST_DIRECTORY = "META-INF/test/";
    ...
    private T createExtension(String name) {
        ...
        try {
            ...
            if (instance == null) {
                //反射生成对象
                EXTENSION_INSTANCES.putIfAbsent(clazz, (T) clazz.getDeclaredConstructor().newInstance());
    ...
    private Map<String, Class<?>> loadExtensionClasses() {
        ...
        Map<String, Class<?>> extensionClasses = new HashMap<>(64);
        loadFile(extensionClasses, TEST_DIRECTORY);
