 ...
 * 文件压缩
 * @author wanchongyang
 * @date 2019/9/15 9:45 下午
 */
@OutputTimeUnit(TimeUnit.SECONDS)
@BenchmarkMode({Mode.AverageTime})
public class FileCompress {
    //要压缩的图片文件所在所存放位置
    public static String JPG_FILE_PATH = "/Users/martin/tools/test/Yosemite3.jpg";

    //zip压缩包所存放的位置
    public static String ZIP_FILE = "/Users/martin/tools/test/Yosemite3.zip";
